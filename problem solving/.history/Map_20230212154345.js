let people=[
  ...
  {name:'ahmed',age:12,job:' front Developer'}, 
   {name:'omar',age:12,job:'  Developer'},
   {name:'omar',age:12,job:' frontend Developer'},
   {name:'omar',age:12,job:' backend Developer'},
...
const newArray=
people.filter(person=>person.name==='omar')
.filter(person=>person.jon==='developer');
