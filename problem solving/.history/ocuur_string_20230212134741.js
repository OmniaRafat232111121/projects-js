...
// function checkPlaindroma(str){
// str=str.replace(/\w/g,"").toLowerCase();
// return(str==str.split("").reverse().join());
// }
// console.log(checkPlaindroma('madah'))



// let child_student=[3,4,5,9,10];
// let newArray=child_student.slice().reverse();
// console.log(newArray)
...
// let replaceAt=1;
// let element=15;
// const newStudent=[...child_student.slice(0,replaceAt),element,...child_student.slice(replaceAt)];
// console.log(newStudent)



// let  child_student=[12,45,54,91,10];
// let element=3;
// let insertAt=2;
// let newElement=[...child_student.slice(0,insertAt),element,...child_student.slice(insertAt)];
// console.log(newElement)



// let  child_student=[12,45,54,91,10,2];
// let to_Delete=12;
// let newElement=[...child_student].filter((item)=>{
...
//how to copy of object Clone without any changing the object orginal
// let employee={
//   id:'3',
//   name:'omnia',
//   age:23
...
//   age:23
// }
// let modified_employeee={
//   ...employee,
//   age:33
// }
// console.log(modified_employeee)
...
function getDecimalPart(num) {
  ...
  const decimalStr = num.toString().split('_')[1];
  return Number(decimalStr);
}

console.log(getDecimalPart(12.345)); 
